...
(
	...
	sort_num tinyint unsigned not null comment '排序权重',
...
(
	...
	goods_number mediumint unsigned not null comment '商品数量',	
...
(
	...
	click_count smallint unsigned not null default '0' comment '有用',
	primary key (id),
	key(goods_id)
...
(
	id mediumint unsigned not null default '0' comment '现有索引最后一件商品ID',	
)engine=InnoDB default charset=utf8 comment 'sphinx';
INSERT INTO s11_sphinx_id VALUES(0);
