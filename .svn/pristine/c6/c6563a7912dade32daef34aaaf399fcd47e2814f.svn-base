...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Category/edit/id/2.html" enctype="multipart/form-data" >
		...
		<tr>
				...
				<td>
					...
					<?php foreach ($tree as $k=>$v): if($v['id'] == $data['id'] || in_array($v['id'] , $children)) continue; if($v['id'] == $data['parent_id']) $selected = 'selected="selected"'; else $selected = ''; ?>
