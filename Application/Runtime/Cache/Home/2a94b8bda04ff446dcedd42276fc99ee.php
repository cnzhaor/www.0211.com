			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					...
					<?php foreach ($goods1 as $k=>$v):?>
						<li>
							<dl>
								<dt><a href="<?php echo U('goods?id='.$v['id']);?>" target="_blank"><?php showImage($v['mid_logo']);?></a></dt>
								<dd><a href="<?php echo U('goods?id='.$v['id']);?>" target="_blank"><?php echo $v['goods_name'] ;?></a></dd>
		...
		<div class="floor_left fl">
			...
			<div class="goodslist fl">
				...
				<?php foreach ($v['recSubCat'] as $k1=>$v1):?>
					<span class="<?php if($k1==0) echo 'on';?>"><?php echo $v1['cat_name'];?></span>
				<?php endforeach;?>
				</h2>
				<div class="goodslist_wrap">
				<?php foreach ($v['recSubCat'] as $k1=>$v1):?>
					<div class="<?php if($k1>0) echo 'none';?>">
						<ul>
						<?php foreach ($v1['goods'] as $k2=>$v2):?>
							<li>
								<dl>
									<dt><a href="<?php echo U('goods?id='.$v2['id']);?>" target="_blank"><?php showImage($v2['mid_logo']);?></a></dt>
